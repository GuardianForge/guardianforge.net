      ...
      <Row>
        <Col md={4} className="footer-col">
          ...
          <div className="footer-content">
            <FontAwesomeIcon icon={faPenSquare} /> <a href="/blog">Blog </a>
            <FontAwesomeIcon icon={faBook} /> <a href="/docs">Docs </a>
            <FontAwesomeIcon icon={faBook} /> <a href="/about">About </a>
        ...
        <Col md={4} className="footer-col">
          ...
          <div>
            <p>GuardianForge was made by <a href="https://twitter.com/brianmmdev" className="underline" target="_blank" rel="noreferrer">@brianmmdev</a></p>
            <p>If you would like to support the development of Forge, please consider <a href="https://www.buymeacoffee.com/brianmmdev" className="underline" target="_blank" rel="noreferrer">buying me a coffee</a>!</p>
          </div>
        </Col>
      </Row>
    </Wrapper>
