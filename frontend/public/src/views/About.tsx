    ...
    <MainLayout>
      <div className="about container">
        ...
        <div className="row page-body">
          ...
          <p>I plan to further document the journey on my <a href="https://brianmorrison.me/blog" target="_blank" rel="noreferrer">personal blog</a> and YouTube channel over the coming weeks. Feel free to follow me <a href="https://twitter.com/brianmmdev" target="_blank"  rel="noreferrer">@brianmmdev</a> or <a href="https://twitter.com/guardianforge" target="_blank" rel="noreferrer">@guardianforge</a> on Twitter for updates as they are released.</p>
          ...
          <p><i>Have other suggestions? Feel free to give me feedback using <a href="https://forms.gle/5i8BG34h6Kv5F7zk9" target="_blank" rel="noreferrer">this form.</a></i></p>
        </div>
      </div>
